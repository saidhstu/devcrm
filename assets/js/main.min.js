...
function _make_task_checklist_items_deletable() {
    if ("1" == app.options.has_permission_tasks_checklist_items_delete) {
        ...
        $.each(e, function (e, t) {
            var a = $(t);
            0 === $(i[e]).find(".checklist-item-template-remove").length &&
                $(i[e])
                    .find("a > span.text")
                    .after('<small class="checklist-item-template-remove" onclick="remove_checklist_item_template(' + a.attr("value") + '); event.stopPropagation();"><i class="fa fa-remove"></i></small>');
        });
    }
}
    ...
    if (0 < a.length) {
        ...
        a
            ...
            $.each(e, function (e, t) {
                (i = " "),
                    !0 === t.started_timers
                        ? (i += 'disabled class="text-danger important" data-subtext="' + app.lang.invoice_task_billable_timers_found + '"')
        ...
        (s = empty(t) ? app.lang.invoice_task_item_project_tasks_not_included : app.lang.showing_billable_tasks_from_project + " " + $("#project_id option:selected").text().trim()),
            n.html(
                '<span class="pointer popover-invoker" data-container=".form-group-select-task_select" data-trigger="click" data-placement="top" data-toggle="popover" data-content="' + s + '"><i class="fa fa-question-circle"></i></span>'
            ),
            delay(function () {
...
function mainWrapperHeightFix() {
    ...
    setup_menu.css("min-height", $(document).outerHeight(!0) - 126 + "px"),
        ...
        e < t && t < $(window).height() && content_wrapper.css("min-height", $(window).height() - 63 + "px"),
...
function delete_option(t, e) {
    confirm_delete() &&
        requestGetJSON("settings/delete_option/" + e).done(function (e) {
...
function initDataTable(e, t, a, i, n, s) {
    ...
    var m = {
            ...
            initComplete: function (e, t) {
                ...
                s.length && s.attr("colspan", a.find("thead th").length),
                    is_mobile() &&
                        $(window).width() < 400 &&
                        0 < a.find('tbody td:first-child input[type="checkbox"]').length &&
    ...
    if (
        ...
        $.each(v, function () {
            var e = $(this).attr("id");
            -1 < $.inArray(e, b) && u.column("#" + e).visible(!1);
        });
    }
    return (
...
function update_todo_items() {
    ...
    $.each(e, function () {
        ...
        0 === e.length
            ...
            : 0 < e.length && ($(".unfinished-todos li.no-todos").hasClass("hide") || $(".unfinished-todos li.no-todos").addClass("hide"), $(".nav-total-todos").removeClass("hide").html(e.length)),
        (x = 1),
        $.each(t, function () {
...
function logout() {
    if (0 < $(".started-timers-top").find("li.timer").length)
        return (
...
function edit_reminder(i, e) {
    requestGetJSON("misc/get_reminder/" + i).done(function (e) {
        ...
        0 === t.length && $("body").hasClass("all-reminders")
            ? ((t = $(".reminder-modal--")).find('input[name="rel_type"]').val(e.rel_type), t.find('input[name="rel_id"]').val(e.rel_id))
            : $("#task-modal").is(":visible") &&
              ((t = $("#newTaskReminderToggle")).attr("data-edit") && t.attr("data-edit") == i
                  ? (t.slideUp(), t.removeAttr("data-edit"))
                  : (t.slideDown(400, function () {
                        fix_task_modal_left_col_height();
                    }),
                    t.attr("data-edit", i),
                    t.isInViewport() || $("#task-modal").animate({ scrollTop: t.offset().top + "px" }, "fast")),
              (a = admin_url + "tasks/edit_reminder/" + i),
              $("#taskReminderFormSubmit").html(app.lang.save)),
            t.find("form").attr("action", a),
            t.find("form").attr("data-edit", !0),
            t.find("#description").val(e.description),
            t.find("#date").val(e.date),
            t.find("#staff").selectpicker("val", e.staff),
            t.find("#notify_by_email").prop("checked", 1 == e.notify_by_email),
            t.hasClass("modal") && t.modal("show");
    });
}
function reminderFormHandler(t) {
    var e = (t = $(t)).serialize();
    return (
        $.post(t.attr("action"), e).done(function (e) {
        ...
        $("body").hasClass("all-reminders") ? $(".reminder-modal--").modal("hide") : $(".reminder-modal-" + t.find('[name="rel_type"]').val() + "-" + t.find('[name="rel_id"]').val()).modal("hide"),
        !1
    );
}
...
function edit_note(t) {
    var a = $("body")
        .find('[data-note-edit-textarea="' + t + '"] textarea')
        .val();
    "" !== a &&
        ($.post(admin_url + "misc/edit_note/" + t, { description: a }).done(function (e) {
            (!0 !== (e = JSON.parse(e)).success && "true" != e.success) ||
                (alert_float("success", e.message),
                $("body")
                    .find('[data-note-description="' + t + '"]')
                    .html(nl2br(a)));
        }),
        toggle_edit_note(t));
}
...
function kanban_load_more(t, a, e, i, n) {
    ...
    if (d <= r) {
        ...
        0 != c.length && "" !== c.val() && ((o.sort_by = c.val()), (o.sort = p)),
            ...
            (o.page = d),
            o.page++,
            requestGet(buildUrl(admin_url + e, o))
                .done(function (e) {
...
function load_more_comments(t) {
    ...
    i <= e &&
        ($.post(admin_url + "newsfeed/init_post_comments/" + a, { page: i }).done(function (e) {
            $(t).data("track-load-comments", i), $('[data-comments-postid="' + a + '"] .load-more-comments').before(e);
        }),
        i++,
        $(t).find('input[name="page"]').val(i),
        e - 1 <= i && ($(t).addClass("hide"), $(t).removeClass("display-block")));
}
...
function add_comment(t) {
    var a = $(t).data("postid");
    $.post(admin_url + "newsfeed/add_comment", { content: $(t).val(), postid: a }).done(function (e) {
        (!0 !== (e = JSON.parse(e)).success && "true" != e.success) ||
            ($(t).val(""),
            0 < $("body").find('[data-comments-postid="' + a + '"] .post-comment').length
                ? $("body")
                      .find('[data-comments-postid="' + a + '"] .post-comment')
                      .prepend(e.comment)
                : refresh_post_comments(a));
    });
}
...
function delete_post(t) {
    confirm_delete() &&
        $.post(
            admin_url + "newsfeed/delete_post/" + t,
            function (e) {
...
function lead_add_inline_select_submit(a) {
    ...
    if ("" !== i) {
        var e = a;
        -1 < a.indexOf("lead_") && (e = e.replace("lead_", ""));
        var t = {};
        (t.name = i),
            (t.inline = !0),
            $.post(admin_url + "leads/" + e, t).done(function (e) {
    ...
    $("#new_lead_" + a + "_inline").remove(),
        $(".form-group-select-input-" + a).removeClass("hide"),
...
function validate_lead_form() {
    ...
    $.each(leadUniqueValidationFields, function (e, t) {
        (a[t] = {}),
            ...
            void 0 !== app.lang[t + "_exists"] && (i[t] = { remote: app.lang[t + "_exists"] });
    }),
...
function update_all_proposal_emails_linked_to_lead(t) {
    $.post(admin_url + "leads/update_all_proposal_emails_linked_to_lead/" + t, { update: !0 }).done(function (e) {
...
function _lead_init_data(e, i) {
    ...
    $("#lead_reminder_modal").html(e.leadView.reminder_data),
        a.find(".data").html(e.leadView.data),
        a.modal({ show: !0, backdrop: "static" }),
        init_tags_inputs(),
        init_selectpicker(),
        init_form_reminder(),
        init_datepicker(),
        ...
        validate_lead_form();
    if (
        (-1 < ["#tab_lead_profile", "#attachments", "#lead_notes", "#lead_activity", "#gdpr"].indexOf(t) && (window.location.hash = t),
...
function delete_lead_attachment(t, e, a) {
    confirm_delete() &&
        requestGetJSON("leads/delete_attachment/" + e + "/" + a)
            .done(function (e) {
...
function delete_lead_note(t, e, a) {
    confirm_delete() &&
        requestGetJSON("leads/delete_note/" + e + "/" + a)
            .done(function (e) {
...
function lead_mark_as_lost(t) {
    requestGetJSON("leads/mark_as_lost/" + t)
        .done(function (e) {
            (!0 !== e.success && "true" != e.success) ||
                ...
                $("body")
                    ...
                    .remove(),
                $("body")
                    .find('#kan-ban li[data-lead-id="' + t + '"]')
                    .remove()),
...
function lead_mark_as_junk(t) {
    requestGetJSON("leads/mark_as_junk/" + t)
        .done(function (e) {
            (!0 !== e.success && "true" != e.success) ||
                (alert_float("success", e.message),
                $("body")
...
function init_proposal_editor() {
    ...
    $.each(proposalsTemplates, function (e, t) {
        a.push({ url: admin_url + "proposals/get_template?name=" + t, title: t });
    });
    var e = {
    ...
    is_mobile() &&
        ((e.theme = "modern"),
        (e.mobile = {}),
        (e.mobile.theme = "mobile"),
        (e.mobile.toolbar = _tinymce_mobile_toolbar()),
        (e.inline = !1),
        window.addEventListener("beforeunload", function (e) {
            tinymce.activeEditor.isDirty() && save_proposal_content();
        })),
        0 < a.length && ((e.templates = a), (e.plugins[3] = "template " + e.plugins[3]), (e.contextmenu = e.contextmenu.replace("inserttable", "inserttable template"))),
        tinymce.init(e);
}
...
function remove_proposal_comment(t) {
    confirm_delete() &&
        requestGetJSON("proposals/remove_comment/" + t).done(function (e) {
            1 == e.success && $('[data-commentid="' + t + '"]').remove();
        });
}
function edit_proposal_comment(t) {
    var a = $("body")
        .find('[data-proposal-comment-edit-textarea="' + t + '"] textarea')
        .val();
    "" != a &&
        ($.post(admin_url + "proposals/edit_comment/" + t, { content: a }).done(function (e) {
            1 == (e = JSON.parse(e)).success &&
                (alert_float("success", e.message),
                $("body")
                    .find('[data-proposal-comment="' + t + '"]')
                    .html(nl2br(a)));
        }),
...
function save_proposal_content(t) {
    ...
    (e.proposal_id = proposal_id),
        ...
        $.post(admin_url + "proposals/save_proposal_data", e)
            .done(function (e) {
...
function recalculate_checklist_items_progress() {
    var e = $('input[name="checklist-box"]:checked').length,
        ...
        a = 0,
        i = $(".task-progress-bar");
    if (($(".task-total-checklist-completed").text(e), 0 == t ? ($("body").find(".chk-heading").remove(), $("#task-no-checklist-items").removeClass("hide")) : $("#task-no-checklist-items").addClass("hide"), !(2 < t)))
        return i.parents(".progress").addClass("hide"), 0 < e ? $(".chk-toggle-buttons").removeClass("hide") : $(".chk-toggle-buttons").addClass("hide"), !1;
    i.parents(".progress").removeClass("hide"),
        ...
        i.text(a.toFixed(2) + "%"),
        0 < e ? $(".chk-toggle-buttons").removeClass("hide") : $(".chk-toggle-buttons").addClass("hide"),
    ...
    requestGetJSON("tasks/remove_checklist_item_template/" + n).done(function (e) {
        if (!0 === e.success || "true" == e.success) {
            ...
            $.each(a, function (e, t) {
                ...
                t.find('option[value="' + n + '"]').remove(),
                t.selectpicker("refresh"),
                1 === t.find("option").length && (t.selectpicker("destroy"), $(".checklist-templates-wrapper").addClass("hide"));
        }
    });
}
function save_checklist_item_template(e, a) {
    var i = $('.checklist[data-checklist-id="' + e + '"] textarea').val();
    $.post(admin_url + "tasks/save_checklist_item_template", { description: i }).done(function (e) {
...
function add_task_checklist_item(e, t, a) {
    a && $(a).addClass("disabled"),
        (t = void 0 === t ? "" : t),
        $.post(admin_url + "tasks/add_checklist_item", { taskid: e, description: t })
            .done(function () {
...
function update_task_checklist_item(i) {
    ...
    return (
        setTimeout(function () {
            ...
            $.post(admin_url + "tasks/update_checklist_item", { description: t, listid: a }).done(function (e) {
                n.resolve(),
                    !0 === (e = JSON.parse(e)).can_be_template && i.parents(".checklist").find(".save-checklist-template").removeClass("hide"),
                    "" === t &&
                        $("#checklist-items")
                            .find('.checklist[data-checklist-id="' + a + '"]')
                            .remove();
            });
        }, 300),
        n.promise()
...
function init_tasks_checklist_items(a, e) {
    $.post(admin_url + "tasks/init_checklist_items", { taskid: e }).done(function (e) {
...
function add_task_comment(e) {
    var t = {};
    0 < taskCommentAttachmentDropzone.files.length
...
function remove_task_comment(t) {
    confirm_delete() &&
        requestGetJSON("tasks/remove_comment/" + t).done(function (e) {
...
function task_mark_as(t, a, e) {
    ...
    (e += "?single_task=" + i),
        $("body").append('<div class="dt-loader"></div>'),
        requestGetJSON(e).done(function (e) {
            $("body").find(".dt-loader").remove(),
                (!0 !== e.success && "true" != e.success) ||
                    (reload_tasks_tables(),
                    i && _task_append_html(e.taskHtml),
                    5 == t && "function" == typeof _maybe_remove_task_from_project_milestone && _maybe_remove_task_from_project_milestone(a),
                    0 === $(".tasks-kanban").length && alert_float("success", e.message));
        });
}
...
function system_popup(e) {
    ...
    var a = $("<div/>", { id: "system-popup", class: "system-popup" }).appendTo("body"),
        t = "";
    return (
        (t += '<div class="popup-wrapper fadeIn animated">'),
        (t += '<h2 class="popup-message">'),
        (t += e.message),
        (t += "</h2>"),
        (t += '<div class="popup-content">'),
        (t += e.content),
        (t += '<button type="button" class="system-popup-close"> </button>'),
        (t += "</div>"),
        (t += "</div>"),
        a.html(t).removeClass("hide"),
        $("body").addClass("system-popup"),
        a.find(".system-popup-close").on("click", function () {
            var t = this;
    ...
    if ("" !== t || !n.is(":visible")) {
        if ("" !== a && "0" == t) {
            ...
            return (
                ...
                (s.content += "</div>"),
                (s.content += "<button type='button' onclick='timer_action(this,document.getElementById(\"timer_add_task_id\").value," + a + ");return false;' class='btn btn-info'>" + app.lang.confirm + "</button>"),
...
function save_edited_comment(t, e) {
    ...
    (a.id = t),
        (a.task_id = e),
        (a.content = $('[data-edit-comment="' + t + '"]')
            .find("textarea")
            .val()),
        is_ios() && (a.no_editor = !0),
        $.post(admin_url + "tasks/edit_comment", a).done(function (e) {
...
function tasks_kanban_update(e, t) {
    if (t === e.item.parent()[0]) {
        ...
        $.each(i, function () {
            ...
            task_mark_as(a, $(e.item).data("task-id")),
              ...
              tinymce.init({
                  ...
                  setup: function (t) {
                      t.on("blur", function (e) {
                          t.isDirty() && $.post(admin_url + "tasks/update_task_description/" + a, { description: t.getContent() }),
                              setTimeout(function () {
...
function load_small_table_item(e, t, a, i, n) {
    ...
    "" === s || window.location.hash ? window.location.hash && !e && (e = window.location.hash.substring(1)) : ((e = s), $('input[name="' + a + '"]').val("")),
        void 0 !== e &&
            ...
            is_mobile() && $("html, body").animate({ scrollTop: $(t).offset().top + 150 }, 600));
}
...
function clear_billing_and_shipping_details() {
    for (var e in billingAndShippingFields)
        -1 < billingAndShippingFields[e].indexOf("country")
...
function init_billing_and_shipping_details() {
    ...
    for (var a in billingAndShippingFields)
        (e = ""),
            -1 < billingAndShippingFields[a].indexOf("country")
                ? (e = $("#" + billingAndShippingFields[a] + " option:selected").data("subtext"))
                : -1 < billingAndShippingFields[a].indexOf("shipping_street") || -1 < billingAndShippingFields[a].indexOf("billing_street")
            ...
            -1 < billingAndShippingFields[a].indexOf("shipping") && (t || (e = "")),
            void 0 === e && (e = ""),
            (e = "" !== e ? e : "--"),
...
function add_task_to_preview_as_item(a) {
    requestGetJSON("tasks/get_billable_task_data/" + a).done(function (e) {
        ...
        var t = $(".main");
        t.find('textarea[name="description"]').val(e.name),
            t.find('textarea[name="long_description"]').val(e.description),
            t.find('input[name="quantity"]').val(e.total_hours),
            t.find('input[name="rate"]').val(e.hourly_rate),
            t.find('input[name="unit"]').val(""),
            $('input[name="task_id"]').val(a),
            $(document).trigger({ type: "item-added-to-preview", item: e, item_type: "task" });
    });
}
...
function add_item_to_table(n, s, e, t) {
    if ("" !== (n = void 0 === n || "undefined" == n ? get_item_preview_values() : n).description || "" !== n.long_description || "" !== n.rate) {
        ...
        var l = /<br[^>]*>/gi;
        return (
            get_taxes_dropdown_template(a, n.taxname).done(function (e) {
                (p += '<input type="hidden" class="order" name="newitems[' + _ + '][order]">'),
                    (p += "</td>"),
                    (p += '<td class="bold description hide"><textarea name="newitems[' + _ + '][description]" class="form-control" rows="5">' + n.description + "</textarea></td>"),
                    (p += '<td class="hide"><textarea name="newitems[' + _ + '][long_description]" class="form-control item_long_description" rows="5">' + n.long_description.replace(l, "\n") + "</textarea></td>");
                ...
                0 < t.length &&
                    ...
                    (p += '<td class="hide"><input type="hidden" min="0" onblur="calculate_total();" onchange="calculate_total();" data-quantity name="newitems[' + _ + '][qty]" value="' + n.qty + '" class="form-control">'),
                    ...
                    (p += '<td class="amount" align="right">' + format_money(o, !0) + "</td>"),
                    (p += '<td><a href="#" class="btn btn-danger pull-right" onclick="delete_item(this,' + s + '); return false;"><i class="fa fa-trash"></i></a></td>'),
                    (p += "</tr>"),
...
function get_taxes_dropdown_template(e, t) {
    ...
    var a = $.post(admin_url + "misc/get_taxes_dropdown_template/", { name: e, taxname: t });
    return jQuery.ajaxSetup({ async: !0 }), a;
}
...
function get_item_preview_values() {
    var e = {};
    return (
        ($('.main textarea[name="description"]').val('NA')),
        (e.description = $('.main textarea[name="description"]').val()),
        ($('.main textarea[name="long_description"]').val('NA')),
...
function calculate_total() {
    ...
    $(".tax-area").remove(),
        $.each(p, function () {
            "" === (t = $(this).find("[data-quantity]").val()) && ((t = 1), $(this).find("[data-quantity]").val(1)),
                (s = accounting.toFixed($(this).find("td.rate input").val() * t, app.options.decimal_places)),
                (s = parseFloat(s)),
                $(this).find("td.amount").html(format_money(s, !0)),
                (d += s),
                (n = $(this)),
                (e = $(this).find("select.tax").selectpicker("val")) &&
                    $.each(e, function (e, t) {
                        (i = n.find('select.tax [value="' + t + '"]').data("taxrate")),
                            (a = (s / 100) * i),
                            l.hasOwnProperty(t)
                                ? (l[t] = l[t] += a)
                                : 0 != i && ((o = t.split("|")), (tax_row = '<tr class="tax-area"><td>' + o[0] + "(" + i + '%)</td><td id="tax_id_' + slugify(t) + '"></td></tr>'), $(_).after(tax_row), (l[t] = a));
                    });
        }),
        "" !== u && 0 != u && "before_tax" == v && h.hasClass("discount-type-percent") ? (c = (d * u) / 100) : "" !== f && 0 != f && "before_tax" == v && h.hasClass("discount-type-fixed") && (c = f),
        $.each(l, function (e, t) {
        ...
        (r += d),
        "" !== u && 0 != u && "after_tax" == v && h.hasClass("discount-type-percent") ? (c = (r * u) / 100) : "" !== f && 0 != f && "after_tax" == v && h.hasClass("discount-type-fixed") && (c = f),
        (r -= c),
        (m = parseFloat(m)),
        isNaN(m) || (r += m);
    ...
    $('input[name="discount_total"]').val(accounting.toFixed(c, app.options.decimal_places)),
        ...
        $(".subtotal").html(format_money(d) + hidden_input("subtotal", accounting.toFixed(d, app.options.decimal_places))),
        $(".total").html(format_money(r) + hidden_input("total", accounting.toFixed(r, app.options.decimal_places))),
...
function delete_invoice_attachment(t) {
    confirm_delete() &&
        requestGet("invoices/delete_attachment/" + t)
            .done(function (e) {
                1 == e &&
                    ($("body")
                        .find('[data-attachment-id="' + t + '"]')
                        .remove(),
...
function delete_credit_note_attachment(t) {
    confirm_delete() &&
        requestGet("credit_notes/delete_attachment/" + t)
            .done(function (e) {
                1 == e &&
                    ($("body")
                        .find('[data-attachment-id="' + t + '"]')
...
function delete_estimate_attachment(a) {
    confirm_delete() &&
        requestGet("estimates/delete_attachment/" + a)
            .done(function (e) {
                if (1 == e) {
                    $("body")
                        .find('[data-attachment-id="' + a + '"]')
                        .remove();
...
function delete_proposal_attachment(a) {
    confirm_delete() &&
        requestGet("proposals/delete_attachment/" + a)
            .done(function (e) {
                if (1 == e) {
                    var t = $("body").find('input[name="_attachment_sale_id"]').val();
                    $("body")
                        .find('[data-attachment-id="' + a + '"]')
                        .remove(),
                        $("body").hasClass("proposals-pipeline") ? proposal_pipeline_open(t) : init_proposal(t);
                }
            })
            .fail(function (e) {
                alert_float("danger", e.responseText);
...
function estimates_pipeline_update(e, t) {
    if (t === e.item.parent()[0]) {
        ...
        $.each(n, function () {
            ...
            $.post(admin_url + "estimates/update_pipeline", a);
    }
}
function proposals_pipeline_update(e, t) {
    if (t === e.item.parent()[0]) {
        ...
        $.each(i, function () {
            ...
            $.post(admin_url + "proposals/update_pipeline", a);
    }
}
...
function delete_sales_note(n, e) {
    confirm_delete() &&
        requestGetJSON("misc/delete_note/" + e).done(function (e) {
            if (!0 === e.success || "true" == e.success) {
            ...
            if (4 == t.length) {
                ...
                if (a.hasClass("format-n-yy")) t = t.substr(-2);
                    ...
                    "d-m-Y" == app.options.date_format || "d/m/Y" == app.options.date_format || "Y-m-d" == app.options.date_format || "d.m.Y" == app.options.date_format
                        ? (i = 1)
                        : ("m-d-Y" != app.options.date_format && "m.d.Y" != app.options.date_format && "m/d/Y" != app.options.date_format) || (i = 0),
                        $("#prefix_month").html(n[i]);
                }
                a.html(t);
            }
        });
...
function requestGet(e, t) {
    t = void 0 === t ? {} : t;
    var a = { type: "GET", url: -1 < e.indexOf(admin_url) ? e : admin_url + e };
...
function get_templates(e, t) {
    "proposals" === e ? $("#proposal-templates").load(admin_url + "templates", { rel_type: e, rel_id: t }) : "contracts" === e && $("#contract-templates").load(admin_url + "templates", { rel_type: e, rel_id: t });
}
...
function add_template(e, t) {
    $("#modal-wrapper").load(admin_url + "templates/modal", { slug: "new", rel_type: e, rel_id: t }, function () {
        $("#TemplateModal").is(":hidden") && $("#TemplateModal").modal({ backdrop: "static", show: !0 }), appValidateForm($("#template-form"), { name: "required" }), tinymce.remove("#content"), init_editor("#content");
    });
}
...
function delete_template(t, a, e) {
    confirm_delete() &&
        $.post(admin_url + "templates/delete/" + e).done(function (e) {
            (!0 !== (e = JSON.parse(e)).success && "true" != e.success) ||
                ("proposals" === a ? $(t).parents(".proposal-templates-wrapper").html("") : "contracts" === a && $(t).parents(".contract-templates-wrapper").html(""), get_templates(a));
        });
}
            ...
            .done(function (e) {
                if ((e = JSON.parse(e)).hasOwnProperty("alert_type")) alert_float(e.alert_type, e.message);
                    ...
                    e.forEach(function (e) {
                        ...
                        a.html(t),
                        a.selectpicker("refresh"),
                        i || a.selectpicker("val", a.find("option:eq(0)")[0].value);
                }
                n.resolve(e);
            })
            .fail(function (e) {
...
$("body").on("loaded.bs.select change", "select.ajax-search", function (e) {
    ...
    if ((!Array.isArray(t) || 0 != t.length) && t && !$(this).is(":disabled")) {
        ...
        if (0 === a.find(".ajax-clear-values").length) {
            ...
            a.addClass("ajax-remove-values-option")
                ...
                .after('<span class="pointer ajax-clear-values" onclick="deselect_ajax_search(this); return false;" data-id="' + i + '"><i class="fa fa-remove"></i></span>');
        }
    }
}),
    ...
    $(function () {
        var e, t;
        0 < totalUnreadNotifications && (document.title = "(" + totalUnreadNotifications + ") " + doc_initial_title),
            ...
            $("body").hasClass("has-deprecated-errors") &&
                ...
                0 < t && $("#menu, #setup-menu-wrapper").css("top", t + 70 + "px")),
            $("form")
        ...
        if (
            ...
            $("body").on("change", ".task-single-inline-field", function () {
                ...
                $.each(e, function () {
                    ...
                    "startdate" == e && "" === t ? a.addClass("text-danger") : "startdate" == e && "" !== t && a.removeClass("text-danger"),
                        (("startdate" == e && "" !== t) || "startdate" != e) && ((i[$(this).attr("name")] = t), "startdate" != e && "" === t ? a.css("opacity", 0.5) : a.css("opacity", 1));
                });
            ...
            $("body").on("click", ".task-single-add-timesheet", function (e) {
                ...
                if (("" !== t && "" !== a) || "" !== i) {
                    var n = {};
                    (n.timesheet_duration = i),
                        (n.start_time = t),
                        (n.end_time = a),
                        (n.timesheet_task_id = $(this).data("task-id")),
                        (n.note = $("body").find("#task_single_timesheet_note").val()),
                        (n.timesheet_staff_id = $("body").find('#task-modal select[name="single_timesheet_staff_id"]').val()),
                        $.post(admin_url + "tasks/log_time", n).done(function (e) {
                            !0 === (e = JSON.parse(e)).success || "true" == e.success
                                ? (init_task_modal(n.timesheet_task_id),
                                  alert_float("success", e.message),
                                  setTimeout(function () {
                                      reload_tasks_tables();
                                  }, 20))
        ...
        if ((table_leads = $("table.table-leads")).length) {
            ...
            0 < p.length && (_.push(p.index()), m.push(p.index())),
        ...
        if (
            ...
            $("body").on("click", ".cpicker", function () {
                ...
                $(this).parents(".cpicker-wrapper").find(".cpicker-big").removeClass("cpicker-big").addClass("cpicker-small"),
                    ...
                    $(this).hasClass("kanban-cpicker")
                        ? ($(this).parents(".panel-heading-bg").css("background", e),
                          $(this)
                              .parents(".panel-heading-bg")
            ...
            $(".notifications-wrapper").on("show.bs.dropdown", function () {
                0 < notifications_wrapper.find(".notifications").attr("data-total-unread") &&
        ...
        $("#send_file").on("show.bs.modal", function (e) {
            ...
            t.find('input[name="filetype"]').val($($(e.relatedTarget)).data("filetype")),
                ...
                0 < $('input[name="email"]').length && t.find('input[name="send_file_email"]').val($('input[name="email"]').val());
        }),
        ...
        $("body").on("click", ".open_newsfeed, .close_newsfeed", function (e) {
            e.preventDefault(),
                void 0 === $(this).data("close")
                    ...
                    : !0 === $(this).data("close") && (newsFeedDropzone.destroy(), $("#newsfeed").html(""), (postid = void (track_load_comment_likes = track_load_post_likes = newsfeed_posts_page = 0))),
                $("#newsfeed").toggleClass("hide"),
                $("body").toggleClass("noscroll");
        }),
        0 < $("[data-newsfeed-auto]").length && (769 < $(window).width() ? $(".open_newsfeed.desktop").click() : $(".open_newsfeed.mobile").click()),
        ...
        $("body").on("submit", "._transaction_form", function () {
            ...
            var e = $(this).find("table.items"),
                t = e.find(".main");
            return t.find('[name="description"]').length && 0 < t.find('[name="description"]').val().trim().length && 0 < t.find('[name="rate"]').val().trim().length
                ? (e.before(
            ...
            $("body").on("submit", "#sales-notes", function () {
                var t = $(this);
                if ("" !== t.find('textarea[name="description"]').val())
                    return (
                        $.post(t.attr("action"), $(t).serialize()).done(function (e) {
                            t.find('textarea[name="description"]').val(""),
                                t.hasClass("estimate-notes-form")
                                    ? get_sales_notes(e, "estimates")
                                    : t.hasClass("invoice-notes-form")
                                    ? get_sales_notes(e, "invoices")
                                    : t.hasClass("proposal-notes-form")
                                    ? get_sales_notes(e, "proposals")
                                    : t.hasClass("contract-notes-form") && get_sales_notes(e, "contracts");
                        }),
                        !1
                    );
            }),
            ...
            $("body").on("change", 'div.invoice input[name="date"], div.estimate input[name="date"], div.proposal input[name="date"]', function () {
                ...
                if ((do_prefix_year(e), !(0 < $('input[name="isedit"]').length))) {
                    ...
                    0 < $("body").find("div.estimate").length ? ((a = admin_url + "estimates/get_due_date"), (t = "expirydate")) : 0 < $("body").find("div.proposal").length && ((a = admin_url + "proposals/get_due_date"), (t = "open_till")),
                        "" === e && $('input[name="' + t + '"]').val(""),
                        "" !== e &&
            ...
            "undefined" != typeof Dropbox &&
                0 < $("#dropbox-chooser-sales").length &&
                    ...
                    appCreateDropzoneOptions({
                        ...
                        success: function (e, t) {
                            ...
                            (!0 !== t.success && "true" != t.success) ||
                                ...
                                (n += '<div class="pull-left"><i class="attachment-icon-preview fa fa-file-o"></i></div>'),
            ...
            $("body").on("change", ".invoice #project_id", function () {
                var t = $(this).selectpicker("val");
                if ("" !== t)
                    requestGetJSON("tasks/get_billable_tasks_by_project/" + t).done(function (e) {
                        _init_tasks_billable_select(e, t);
                    });
                else {
                    var e = $("#clientid").selectpicker("val");
                    "" !== e
                        ? requestGetJSON("tasks/get_billable_tasks_by_customer_id/" + e).done(function (e) {
            ...
            $("body").on("change", ".f_client_id #clientid", function () {
                var e = $(this).val(),
                    ...
                    t = o.html("").clone(),
                    l = $(".projects-wrapper");
                if ((o.selectpicker("destroy").remove(), (o = t), $("#project_ajax_search_wrapper").append(t), init_ajax_project_search_by_customer_id(), clear_billing_and_shipping_details(), !e))
                    return $("#merge").empty(), $("#expenses_to_bill").empty(), $("#invoice_top_info").addClass("hide"), l.addClass("hide"), !1;
                ...
                requestGetJSON("invoices/client_change_data/" + e + "/" + (a = void 0 === a ? "" : a)).done(function (e) {
                    ...
                    for (var a in (0 === t.length ? (e.expenses_bill_info = "") : t.html(e.expenses_bill_info),
                    ...
                    billingAndShippingFields))
                        -1 < billingAndShippingFields[a].indexOf("billing") &&
                            (-1 < billingAndShippingFields[a].indexOf("country")
                                ? $('select[name="' + billingAndShippingFields[a] + '"]').selectpicker("val", e.billing_shipping[0][billingAndShippingFields[a]])
                                : -1 < billingAndShippingFields[a].indexOf("billing_street")
                                ? $('textarea[name="' + billingAndShippingFields[a] + '"]').val(e.billing_shipping[0][billingAndShippingFields[a]])
                                : $('input[name="' + billingAndShippingFields[a] + '"]').val(e.billing_shipping[0][billingAndShippingFields[a]]));
                    for (var i in (empty(e.billing_shipping[0].shipping_street) || $('input[name="include_shipping"]').prop("checked", !0).change(), billingAndShippingFields))
                        -1 < billingAndShippingFields[i].indexOf("shipping") &&
                            (-1 < billingAndShippingFields[i].indexOf("country")
                                ? $('select[name="' + billingAndShippingFields[i] + '"]').selectpicker("val", e.billing_shipping[0][billingAndShippingFields[i]])
                                : -1 < billingAndShippingFields[i].indexOf("shipping_street")
                                ? $('textarea[name="' + billingAndShippingFields[i] + '"]').val(e.billing_shipping[0][billingAndShippingFields[i]])
                                : $('input[name="' + billingAndShippingFields[i] + '"]').val(e.billing_shipping[0][billingAndShippingFields[i]]));
                    init_billing_and_shipping_details();
                    var n = e.client_currency,
                        s = $("body").find('.accounting-template select[name="currency"]');
                    0 != (n = parseInt(n)) ? s.val(n) : s.val(s.data("base")),
                        _init_tasks_billable_select(e.billable_tasks, o.selectpicker("val")),
                        !0 === e.customer_has_projects ? l.removeClass("hide") : l.addClass("hide"),
            ...
            $("body").on("change", 'input[name="invoices_to_merge[]"]', function () {
                var e = $(this).prop("checked"),
                    a = $(this).val();
                !0 === e
                    ? requestGetJSON("invoices/get_merge_data/" + a).done(function (e) {
                          $.each(e.items, function (e, t) {
                              "" !== t.rel_type &&
                                  ("task" == t.rel_type ? $('input[name="task_id"]').val(t.item_related_formatted_for_input) : "expense" == t.rel_type && $('input[name="expense_id"]').val(t.item_related_formatted_for_input)),
                                  _set_item_preview_custom_fields_array(t.custom_fields),
                                  add_item_to_table(t, "undefined", a);
                          });
                      })
                    : $("body")
                          .find('[data-merge-invoice="' + a + '"]')
                          .remove();
            }),
