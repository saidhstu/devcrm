...
include('database.php');
                                ...
                                {
                                    echo "<table class='table' id='commission-table'>
                                            <thead>
                                                <tr>
                                                    <th>Invoice #</th>
                                                    <th>Amount</th>
                                    ...
                                    $j=1;
                                    $sql1="select id,number,prefix,date,clientid,currency,sale_agent,total,commission_status from tblinvoices WHERE NOT EXISTS ( SELECT invoiceid FROM invoice_refund WHERE invoiceid = id )";
