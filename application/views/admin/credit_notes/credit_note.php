...
<div class="col-md-12">
  <div class="form-group">
    <label for="" class="control-label">Select Agent</label>
    <select name="agent_id" class="form-control">
      <option value="0">Nothing selected</option>
      <?php foreach ($agents as $key => $result) { ?>
        <?php if($credit_note->agent_id==$result['staffid']){ ?>
          <option value="<?= $result['staffid']; ?>" selected="selected"><?= $result['firstname'] .' '.$result['lastname'] ?></option>
        <?php }else{ ?>
          <option value="<?= $result['staffid']; ?>"><?= $result['firstname'] .' '.$result['lastname'] ?></option>
        <?php } ?>
      <?php } ?>
    </select>
  </div>
...
<div class="table-responsive s_table">
 <table class="table credite-note-items-table items table-main-credit-note-edit has-calculations no-mtop">
  <thead>
   <tr>
    <th></th>
    <th width="20%" align="left" class="hide"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('credit_note_table_item_heading'); ?></th>
    <th width="25%" align="left" class="hide"><?php echo _l('credit_note_table_item_description'); ?></th>
    <?php
  ...
  ?>
  <th width="10%" class="qty hide" align="right"><?php echo $qty_heading; ?></th>
