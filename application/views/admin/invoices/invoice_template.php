...
<div class="panel_s invoice accounting-template">
   ...
   <div class="panel-body mtop10">
      ...
      <div class="table-responsive s_table">
         <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop" id="DataTables_Table_0">
            <thead>
               <tr>
                  <th class="hide"></th>
                  <th class="hide" width="20%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('invoice_table_item_heading'); ?></th>
                  <th class="hide" width="25%" align="left"><?php echo _l('invoice_table_item_description'); ?></th>
                  <?php
                  ...
                  foreach($custom_fields as $cf){
                    echo '<th width="15%" align="left" class="custom_field">' . $cf['name'] . '</th>';
                     ...
                     ?>
                  <th width="10%" align="right"  class="hide qty" class="qty hide"><?php echo $qty_heading; ?></th>
                  <th width="25%" align="left"><?php echo _l('invoice_table_rate_heading'); ?></th>
                  <th width="20%" align="left"><?php echo _l('invoice_table_tax_heading'); ?></th>
            ...
            <tbody>
               <tr class="main">
                  <td class="hide"></td>
                  <td class="hide">
                     <textarea name="description" class="form-control" rows="4" placeholder="<?php echo _l('item_description_placeholder'); ?>">NA</textarea>
                  </td>
                  <td class="hide">
                     <textarea name="long_description" rows="4" class="form-control" placeholder="<?php echo _l('item_long_description_placeholder'); ?>">NA</textarea>
                  </td>
                  <?php echo render_custom_fields_items_table_add_edit_preview(); ?>
                  <td class="hide">
                     <input type="number" name="quantity" min="0" value="1" class="form-control hide" placeholder="<?php echo _l('item_quantity_placeholder'); ?>">
               ...
               <?php if (isset($invoice) || isset($add_items)) {
                  ...
                  foreach ($add_items as $item) {
                    ...
                    $table_row .= '<td class="dragger hide">';
                    ...
                    $table_row .= '</td>';
                    $table_row .= '<td class="bold description hide"><textarea name="' . $items_indicator . '[' . $i . '][description]" class="form-control" rows="5">' . clear_textarea_breaks($item['description']) . '</textarea></td>';
                    $table_row .= '<td class="hide"><textarea name="' . $items_indicator . '[' . $i . '][long_description]" class="form-control" rows="5">' . clear_textarea_breaks($item['long_description']) . '</textarea></td>';

                    $table_row .= render_custom_fields_items_table_in($item,$items_indicator.'['.$i.']');

                    $table_row .= '<td class="hide"><input type="number" min="0" onblur="calculate_total();" onchange="calculate_total();" data-quantity name="' . $items_indicator . '[' . $i . '][qty]" value="' . $item['qty'] . '" class="form-control">';
      ...
      <div class="col-md-8 col-md-offset-4" style="width:100%;margin-left: 0px;">
        <div class="col-md-6">
            <textarea class="form-control" name="insurance_detail" rows="5" placeholder="Descripton"><?php echo (isset($invoice) ? $invoice->insurance_detail : ''); ?></textarea>
        </div>
        <div class="col-md-6">
            ...
            <div class="btn-bottom-toolbar text-right">
              ...
              <div class="btn-group dropup">
                ...
                <ul class="dropdown-menu dropdown-menu-right width200">
                  ...
                  <?php if(!isset($invoice)) { ?>
                  <li class="hide">
                    <a href="#" class="invoice-form-submit save-and-send-later transaction-submit">DataTables_Table_0
