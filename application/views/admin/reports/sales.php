      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
                  ...
                  <div class="row">
                     <div class="col-md-4 border-right">
                      ...
                      <p>
                        ...
                        <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'airlines-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('airlines_report'); ?></a>
                      </p>
                        <hr class="hr-10" />
                      <p>
               ...
               <?php $this->load->view('admin/reports/includes/airlines_report'); ?>
