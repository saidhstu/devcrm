...
<div id="airlines-report" class="hide">
   <div class="row">
      <div class="col-md-4">
   ...
   <?php } ?>
   <?php if(count($airlines['options']) > 0 ) { ?>
      <div class="col-md-4">
         <div class="form-group">
            <label for="sale_agent_airlines"><?php echo _l('report_invoice_airlines'); ?></label>
            <select name="sale_airlines" class="selectpicker" multiple data-width="100%" data-none-selected-text="<?php echo _l('invoice_status_report_all'); ?>">
               <?php foreach($airlines['options'] as $key => $value){ ?>
...
<table class="table table-airlines-report">
   <thead>
      <tr>
         ...
         <th><?php echo _l('report_invoice_airlines'); ?></th>
