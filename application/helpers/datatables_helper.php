...
function render_datatable($headings = [], $class = '', $additional_classes = [''], $table_attributes = [])
{
    ...
    if(!empty($_SESSION['staff_user_id']) && $_SESSION['staff_user_id']!=1){
        $headings = array_diff_key($headings, array_flip((array) ['10']));
        $headings = array_diff_key($headings, array_flip((array) ['11']));
        $headings = array_diff_key($headings, array_flip((array) ['12']));
        $headings = array_diff_key($headings, array_flip((array) ['13']));
        $headings = array_diff_key($headings, array_flip((array) ['14']));
        $headings = array_diff_key($headings, array_flip((array) ['15']));
        $headings = array_diff_key($headings, array_flip((array) ['16']));
        $headings = array_diff_key($headings, array_flip((array) ['17']));
        $headings = array_diff_key($headings, array_flip((array) ['18']));
    }
