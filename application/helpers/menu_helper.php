    ...
    if (has_permission('reports', '', 'view')) {
        ...
        if (is_admin()) {
            $CI->app_menu->add_sidebar_children_item('reports', [
                    ...
                    'name'     => 'Invoice Commission Repport',
                    'href'     => admin_url('commission'),
                    'position' => 31,
            ]);
        }
        if (is_admin()) {
            $CI->app_menu->add_sidebar_children_item('reports', [
                    'slug'     => 'airlines-reports',
                    'name'     => 'Commission Repport',
                    'href'     => admin_url('airlines_report'),
                    'position' => 32,
            ]);
        }
        ...
        if (is_admin()) {
            $CI->app_menu->add_sidebar_children_item('reports', [
                    'slug'     => 'commission-reports',
                    'name'     => 'Credit Note Commission Repport',
                    'href'     => admin_url('Creditnotecommission'),
                    'position' => 31,
            ]);
        }
    }
